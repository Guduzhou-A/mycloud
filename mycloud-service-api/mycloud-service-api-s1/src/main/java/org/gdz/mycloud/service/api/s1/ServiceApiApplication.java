package org.gdz.mycloud.service.api.s1;
...
@SpringBootApplication(scanBasePackages = {"org.gdz.mycloud.service.api.s1.core"})
@Slf4j
@EnableDubbo
...
public class ServiceApiApplication {
    ...
    public static void main(String[] args) {
        ...
        log.info("s1 ServiceApiApplication started successfully");
    }
